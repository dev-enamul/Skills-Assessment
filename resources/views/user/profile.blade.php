...
@section('title', Auth::user()->name . ' |Retinasoft');
@section('style')
    <style>
        main{
...
@section('content')
    <form action="{{ route('profile.update') }}" method="post" id="update_user_form" enctype="multipart/form-data">
        @csrf
        <div class="row mb-4">
            <div class="col-md-1">
            </div>
            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone"
                        value="{{ Auth::user()->status == 1 ? 'Active' : 'Deactive' }}" disabled>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ip_address" value="{{old('ip_address', @$user->details->ip_address)}}" placeholder="192.168.92.5" disabled>
                </div>
